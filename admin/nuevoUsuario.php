      ...
      <div class="masthead">
        ...
        <!--<form class="form-signin"   method="post">-->
          <!--<h3>Usuarios</h3> -->
                          ...
                          <form class="form-signin" action="adminNuevoUsuario.php"  method="post" onsubmit="return valida(this)">
                              ...
                              <table>
                                      <tr>
                                           <td>
                                                ...
                                                <input type="text" class="input-block-level" name="txtUsuario" placeholder="Nombre Usuario" required autofocus="autofocus" >
                                          </td>
                                      </tr>
                                      ...
                                      <tr>
                                           <td>
                                                ...
                                                <input type="text" class="input-block-level"  name="txtContra" placeholder="Contraseña" onKeyUp="validar(this)" required  >
                                          </td>

                                          <td>
                                                <h2 class="form-signin-heading">Confirmar:</h2>
                                                <input type="text" class="input-block-level"  name="txtContra2" placeholder="Confirmar" onKeyUp ="validar(this)" required   >
                                          </td>
                                      </tr>
