...
header('index.php?ErrorLogin=sjbdu212');
  ...
  $queryEditar = "SELECT IdUsuario, Usuario FROM Usuario ORDER BY Usuario ASC";
          ...
          <section class="tablapost">
            <table class="table table-hover">
              ...
              <tbody>
                <?php do{ ?>
                <tr>
                  <td><?php printf("%d", $rowEditar['IdUsuario']); ?></td>
                  <td><?php printf("%s", $rowEditar['Usuario']); ?></td>
                  <td><center><a class="btn btn-danger" href=<?php printf("adminEliminarUsuario.php?IdUsuario=%s", $rowEditar['IdUsuario']); ?>><span> Eliminar</a></center></td>
                </tr>
